#############################################################################
# Makefile for building: NewEpisodes
# Generated by qmake (2.01a) (Qt 4.8.5) on: Tue Feb 4 02:04:38 2014
# Project:  NewEpisodes.pro
# Template: app
# Command: /usr/bin/qmake-qt4 -o Makefile NewEpisodes.pro
#############################################################################
...
Makefile: NewEpisodes.pro  /usr/lib64/qt4/mkspecs/linux-g++/qmake.conf /usr/lib64/qt4/mkspecs/common/unix.conf \
		/usr/lib64/qt4/mkspecs/common/linux.conf \
		/usr/lib64/qt4/mkspecs/common/gcc-base.conf \
		/usr/lib64/qt4/mkspecs/common/gcc-base-unix.conf \
		/usr/lib64/qt4/mkspecs/common/g++-base.conf \
	...
	$(QMAKE) -o Makefile NewEpisodes.pro
...
dist: 
	@$(CHK_DIR_EXISTS) .tmp/NewEpisodes1.0.0 || $(MKDIR) .tmp/NewEpisodes1.0.0 
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/NewEpisodes1.0.0/ && $(COPY_FILE) --parents mainwindow.h .tmp/NewEpisodes1.0.0/ && $(COPY_FILE) --parents main.cpp mainwindow.cpp .tmp/NewEpisodes1.0.0/ && $(COPY_FILE) --parents mainwindow.ui .tmp/NewEpisodes1.0.0/ && (cd `dirname .tmp/NewEpisodes1.0.0` && $(TAR) NewEpisodes1.0.0.tar NewEpisodes1.0.0 && $(COMPRESS) NewEpisodes1.0.0.tar) && $(MOVE) `dirname .tmp/NewEpisodes1.0.0`/NewEpisodes1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/NewEpisodes1.0.0
